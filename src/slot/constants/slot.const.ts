...
export const REEL_STRIPS: readonly [ReelStrip, ReelStrip, ReelStrip, ReelStrip, ReelStrip] = [
  [
    SYMBOL_OBJ.Ten, SYMBOL_OBJ.Ace, SYMBOL_OBJ.Jack, SYMBOL_OBJ.Scatter, SYMBOL_OBJ.Queen, SYMBOL_OBJ.Queen,
  ...
  [
    SYMBOL_OBJ.King, SYMBOL_OBJ.Ace, SYMBOL_OBJ.King, SYMBOL_OBJ.Queen, SYMBOL_OBJ.King, SYMBOL_OBJ.Ace,
    SYMBOL_OBJ.King, SYMBOL_OBJ.Scatter, SYMBOL_OBJ.King, SYMBOL_OBJ.Ten, SYMBOL_OBJ.Jack, SYMBOL_OBJ.King,
  ...
  [
    ...
    SYMBOL_OBJ.Jack, SYMBOL_OBJ.Ace, SYMBOL_OBJ.Queen
  ],
  [
    SYMBOL_OBJ.Queen, SYMBOL_OBJ.Jack, SYMBOL_OBJ.Ten, SYMBOL_OBJ.Ten, SYMBOL_OBJ.Queen, SYMBOL_OBJ.Jack,
    SYMBOL_OBJ.Ten, SYMBOL_OBJ.Queen, SYMBOL_OBJ.Queen, SYMBOL_OBJ.Ace, SYMBOL_OBJ.Scatter, SYMBOL_OBJ.King,
    SYMBOL_OBJ.Ace, SYMBOL_OBJ.Ace, SYMBOL_OBJ.Jack
  ],
  [
    SYMBOL_OBJ.King, SYMBOL_OBJ.Queen, SYMBOL_OBJ.King, SYMBOL_OBJ.Scatter, SYMBOL_OBJ.Queen, SYMBOL_OBJ.King,
    SYMBOL_OBJ.Ace, SYMBOL_OBJ.Ten, SYMBOL_OBJ.Queen, SYMBOL_OBJ.Queen, SYMBOL_OBJ.Jack, SYMBOL_OBJ.King,
    SYMBOL_OBJ.Ten, SYMBOL_OBJ.King, SYMBOL_OBJ.Queen
  ],
];
